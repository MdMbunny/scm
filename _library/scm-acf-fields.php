...
// *****************************************************
	...
	if ( ! function_exists( 'scm_acf_preset' ) ) {
		function scm_acf_preset( $is = array(), $def = array() ) {
            ...
            $default = wp_parse_args( $is, $default );
...
/* Number */
	...
	if ( ! function_exists( 'scm_acf_field_number' ) ) {
		function scm_acf_field_number( $name = '', $default = 0, $width = '', $logic = 0, $placeholder = 'auto', $label = '', $min = '', $max = '', $instructions = '', $required = 0 ) {
			...
			return scm_acf_field( $name, array( 'number', '', ( $default ? 'default' : $placeholder ), $label ), $label, $width, $logic, $instructions, $required );
		}
	}
	...
	if ( ! function_exists( 'scm_acf_field_option' ) ) {
		function scm_acf_field_option( $name = '', $default = 0, $width = '', $logic = 0, $placeholder = 'auto', $label = '', $instructions = '', $required = 0 ) {
			$label = ( $label ?: __( 'Misura', SCM_THEME ) );
			return scm_acf_field( $name, array( 'option', '', ( $default ? 'default' : $placeholder ), $label ), $label, $width, $logic, $instructions, $required );
		}
	}
	...
	if ( ! function_exists( 'scm_acf_field_positive' ) ) {
		function scm_acf_field_positive( $name = '', $default = '', $width = '', $logic = 0, $placeholder = 'auto', $label = '', $instructions = '', $required = 0 ) {
			$label = ( $label ?: __( 'Misura', SCM_THEME ) );
			return scm_acf_field( $name, array( 'positive', $default, $placeholder, $label ), $label, $width, $logic, $instructions, $required );
		}
	}
	...
	if ( ! function_exists( 'scm_acf_field_alpha' ) ) {
		function scm_acf_field_alpha( $name = '', $default = 0, $width = '', $logic = 0, $placeholder = '1', $label = '', $instructions = '', $required = 0 ) {
			...
			return scm_acf_field( $name, array( 'alpha', '', ( $default ? 'default' : $placeholder ), $label ), $label, $width, $logic, $instructions, $required );
		}
	}
...
/* Text */
	...
	if ( ! function_exists( 'scm_acf_field_text' ) ) {
		function scm_acf_field_text( $name = '', $default = '', $width = '', $logic = 0, $placeholder = '', $label = '', $append = '', $max = '', $instructions = '', $required = 0 ) {
			...
			return scm_acf_field( $name, array( 'text', $default, $placeholder, ( $append ?: $label ), '', $max ), $label, $width, $logic, $instructions, $required );
		}
	}
	...
	if ( ! function_exists( 'scm_acf_field_text_req' ) ) {
		function scm_acf_field_text_req( $name = '', $default = 0, $width = '', $logic = 0, $placeholder = '', $label = '', $append = '', $max = '', $instructions = '', $required = 1 ) {
			$placeholder = ( $placeholder ?: __( 'testo', SCM_THEME ) );
			$label = ( $label ?: __( 'Testo', SCM_THEME ) );
			return scm_acf_field( $name, array( 'text', '', ( $default ? 'default' : $placeholder ), ( $append ?: $label ), '', $max ), $label, $width, $logic, $instructions, $required );
		}
	}
	...
	if ( ! function_exists( 'scm_acf_field_name_req' ) ) {
		function scm_acf_field_name_req( $name = '', $default = 0, $max = '', $width = '', $logic = 0, $placeholder = '', $label = '', $instructions = '', $required = 1 ) {
			...
			return scm_acf_field( $name, array( 'name', '', ( $default ? 'default' : $placeholder ), $label, '', $max ), $label, $width, $logic, $instructions, $required );
		}
	}
	...
	if ( ! function_exists( 'scm_acf_field_link' ) ) {
		function scm_acf_field_link( $name = '', $default = 0, $width = '', $logic = 0, $placeholder = 'http://www.esempio.com', $label = '', $instructions = '', $required = 0 ) {
			...
			return scm_acf_field( $name, array( 'link', '', ( $default ? 'default' : $placeholder ), $label ), $label, $width, $logic, $instructions, $required );
		}
	}
	
	// EMAIL
	if ( ! function_exists( 'scm_acf_field_email' ) ) {
		function scm_acf_field_email( $name = '', $default = 0, $width = '', $logic = 0, $placeholder = 'info@esempio.com', $label = '', $instructions = '', $required = 0 ) {

			$label = ( $label ?: __( 'Email', SCM_THEME ) );
			return scm_acf_field( $name, array( 'text', '', ( $default ? 'default' : $placeholder ), $label ), $label, $width, $logic, $instructions, $required );
		}
	}
...
/* Select */
	...
	if ( ! function_exists( 'scm_acf_field_select1' ) ) {
		function scm_acf_field_select1( $name = '', $default = 0, $type = '', $width = '', $logic = 0, $placeholder = '', $label = '', $instructions = '', $required = 0 ) {
			...
			return scm_acf_field( $name, array( 'select' . ( $type ? '-' . $type : '' ) . ( $default ? '-default' : '' ), $placeholder, __( 'Seleziona', SCM_THEME ) . ' ' . $label ), $label, $width, $logic, $instructions, $required );
		}
	}
	...
	if ( ! function_exists( 'scm_acf_field_select' ) ) {
		function scm_acf_field_select( $name = '', $default = 0, $type = '', $width = '', $logic = 0, $placeholder = '', $label = '', $instructions = '', $required = 0 ) {
			$label = ( $label ?: __( 'Elementi', SCM_THEME ) );
			return scm_acf_field( $name, array( 'select2' . ( $type ? '-' . $type : '' ) . ( $default ? '-default' : '' ), $placeholder, __( 'Seleziona', SCM_THEME ) . ' ' . $label ), $label, $width, $logic, $instructions, $required );
		}
	}
...
// *****************************************************
	...
	if ( ! function_exists( 'scm_acf_preset_map_icon' ) ) {
		function scm_acf_preset_map_icon( $name = 'map-icon', $default = 0, $w1 = 100, $logic = 0, $label = '', $instructions = '', $req = 0 ) {
			...
			$fields[] = scm_acf_field_select1( $name . 'icon', $default, 'luogo-mappa', $w1, $logic, array( 'no' => __( 'No icon', SCM_THEME ), 'icon' => __( 'Icona', SCM_THEME ), 'img' => __( 'Immagine', SCM_THEME ) ), __( 'Icona Mappa', SCM_THEME ) );
	...
	if ( ! function_exists( 'scm_acf_preset_button' ) ) {
		function scm_acf_preset_button( $name = '', $default = 0, $type = 'link', $placeholder = '', $filter = '', $options = 0, $pl2 = '', $pl3 = '', $logic = 0, $instructions = '', $required = 0 ) {
			...
			if( $options >= -1 ){
				...
				$fields[] = scm_acf_field_name( $name . 'name', $default, 100, 30, 0, $pl2 );
			...
			switch ( $type ) {
				case 'link':
					$fields[] = scm_acf_field_link( $name . 'link', $default, $width, 0, ( $pl3 ?: __( 'Inserisci un Link', SCM_THEME ) ) );
				break;
				
				case 'file':
					$fields[] = scm_acf_field_file( $name . 'link', $default, $width, 0, $pl3 );
				break;
				...
				case 'paypal':
					$fields[] = scm_acf_field_text( $name . 'link', $default, $width, 0, ( $pl3 ?: __( 'Inserisci Codice PayPal', SCM_THEME ) ), __( 'Code', SCM_THEME ) );
				break;
			...
			if( $options === 1 )
				...
				$fields[] = scm_acf_field_falsetrue( $name . 'onmap', $default, 10, 0, __( 'On Map', SCM_THEME ) );
...
// *****************************************************
	...
	if ( ! function_exists( 'scm_acf_fields_banners' ) ) {
		function scm_acf_fields_banners( $name = '', $default = 0 ) {
	...
	if ( ! function_exists( 'scm_acf_fields_modules' ) ) {
		function scm_acf_fields_modules( $name = '', $default = 0 ) {
	...
	if ( ! function_exists( 'scm_acf_fields_sections' ) ) {
		function scm_acf_fields_sections( $name = '', $default = 0, $elements = '' ) {
	...
	if ( ! function_exists( 'scm_acf_fields_slides' ) ) {
		function scm_acf_fields_slides( $name = '', $default = 0 ) {
	...
	if ( ! function_exists( 'scm_acf_fields_articoli' ) ) {
		function scm_acf_fields_articoli( $name = '', $default = 0 ) {
	...
	if ( ! function_exists( 'scm_acf_fields_rassegne_stampa' ) ) {
		function scm_acf_fields_rassegne_stampa( $name = '', $default = 0 ) {
	...
	if ( ! function_exists( 'scm_acf_fields_documenti' ) ) {
		function scm_acf_fields_documenti( $name = '', $default = 0 ) {
	...
	if ( ! function_exists( 'scm_acf_fields_gallerie' ) ) {
		function scm_acf_fields_gallerie( $name = '', $default = 0 ) {
	...
	if ( ! function_exists( 'scm_acf_fields_luoghi' ) ) {
		function scm_acf_fields_luoghi( $name = '', $default = 0 ) {
			...
			$fields[] = scm_acf_field( 'tab-set-luogo', 'tab-left', __( 'Dati', SCM_THEME ) );
				...
				/*$fields[] = scm_acf_field( 'msg-luogo-nome', array(
					...
					$fields[] = scm_acf_field_name( $name . 'luogo-nome', $default, '', 100, 0, __( 'es. Sede Operativa, Distaccamento, …', SCM_THEME ) );
			...
			$fields[] = scm_acf_field( 'tab-contatti-luogo', 'tab-left', __( 'Contatti', SCM_THEME ) );
				...
				$contacts = scm_acf_field_flexible( $name . 'luogo-contatti', $default, __( 'Aggiungi Contatti', SCM_THEME ), '+' );
					...
					$email = scm_acf_layout( 'email', 'block', __( 'Email', SCM_THEME ) );
						$email['sub_fields'] = scm_acf_preset_button( '', $default, 'link', 'envelope_contact', 'email', 2, __( 'Email', SCM_THEME ), __( 'Email Address', SCM_THEME ) );
					$contacts['layouts'][] = $email;

					$skype = scm_acf_layout( 'skype', 'block', __( 'Skype', SCM_THEME ) );
						$skype['sub_fields'] = scm_acf_preset_button( '', $default, 'link', 'skype_contact', 'skype', 2, __( 'Skype Name', SCM_THEME ), __( 'Skype User Name', SCM_THEME ) );
					$contacts['layouts'][] = $skype;

					$phone = scm_acf_layout( 'phone', 'block', __( 'Telefono', SCM_THEME ) );
						$phone['sub_fields'] = scm_acf_preset_button( '', $default, 'link', 'phone_contact', 'phone', 2, __( 'Tel.', SCM_THEME ), __( 'Phone Number', SCM_THEME ) );
					$contacts['layouts'][] = $phone;

					$fax = scm_acf_layout( 'fax', 'block', __( 'Fax', SCM_THEME ) );
						$fax['sub_fields'] = scm_acf_preset_button( '', $default, 'link', 'file-text_contact', 'fax', 2, __( 'Fax', SCM_THEME ), __( 'Fax Number', SCM_THEME ) );
	...
	if ( ! function_exists( 'scm_acf_fields_soggetti' ) ) {
		function scm_acf_fields_soggetti( $name = '', $default = 0 ) {
		...
		function scm_acf_options_types( $name = '', $default = 0 ) {
			...
			$active = array(
				...
				$types['sub_fields'][] = scm_acf_field( 'tab-menu', 'tab', __( 'Menu', SCM_THEME ), 0, $active );
					$types['sub_fields'][] = scm_acf_field_text( 'icon', 'admin-site', 100, $active, 'admin-site (see below)', __( 'Icona', SCM_THEME ), __( 'Icona', SCM_THEME ) );
					$types['sub_fields'][] = scm_acf_field_text( 'menu', 'types', 50, $active, 'menu-group (see below)', __( 'Zona Menu', SCM_THEME ), __( 'Zona Menu', SCM_THEME ) );
					$types['sub_fields'][] = scm_acf_field_positive( 'menupos', 0, 50, $active, 0, __( 'Posizione Menu', SCM_THEME ), 0, 91 );
			...
			$fields[] = scm_acf_field( 'msg-types-instructions', array(
						...
						<strong>Posizione in Gruppo (menupos):</strong><br>
		...
		function scm_acf_options_general( $name = '', $default = 0 ) {
			...
			$fields[] = scm_acf_field( 'tab-tools-settings', 'tab-left', __( 'Strumenti', SCM_THEME ) );
				...
				$fields[] = scm_acf_field( 'msg-smooth', 'message', __( 'Smooth Scroll', SCM_THEME ) );
					...
					$fields = array_merge( $fields, scm_acf_preset_size( $name . 'opt-tools-smoothscroll-offset', 0, '0', 'px', __( 'Offset', SCM_THEME ) ) );
				...
				$fields[] = scm_acf_field( 'msg-singlenav', 'message', __( 'Single Page Nav', SCM_THEME ) );
					...
					$fields = array_merge( $fields, scm_acf_preset_size( $name . 'opt-tools-singlepagenav-offset', 0, '0', 'px', __( 'Offset', SCM_THEME ) ) );
	...
	if ( ! function_exists( 'scm_acf_options_head_branding' ) ) {
		function scm_acf_options_head_branding( $name = '', $default = 0 ) {
			...
			$tipo = array(
				...
				$fields = array_merge( $fields, scm_acf_preset_size( $name . 'height', '', '40', 'px', __( 'Altezza Massima', SCM_THEME ), $tipo ) );
	...
	if ( ! function_exists( 'scm_acf_options_head_social' ) ) {
		function scm_acf_options_head_social( $name = '', $default = 0 ) {
			...
			$social = array( 'field' => $name . 'enabled', 'operator' => '==', 'value' => 'on' );
				...
				$fields = array_merge( $fields, scm_acf_preset_size( $name . 'size', '', 16, 'px', __( 'Dimensione Icone', SCM_THEME ), $social ) );
				$fields = array_merge( $fields, scm_acf_preset_rgba( $name . 'rgba', '', '', 1, $social ) );

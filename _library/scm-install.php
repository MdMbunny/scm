    ...
    if ( ! function_exists( 'scm_default_types_install' ) ) {
        function scm_default_types_install(){
			...
			$default_types = array(
                ...
                'news'                  => array( 'admin' => 0,      'add_cap' => 1,         'active' => 1,      'public' => 1,       'hidden' => 0,      'post' => 1,       'singular' => __('News', SCM_THEME),                   'plural' => __('News', SCM_THEME),                  'slug' => 'news',               'icon' => 'megaphone',          'orderby' => 'date',        'ordertype' => '',      'menupos' => 0,         'menu' => 3,                                                                                                           ),
        ...
        function scm_option_subpages_install(){
            ...
            if( function_exists('acf_add_options_sub_page') ) {
                ...
                acf_add_options_sub_page(array(
                    ...
                    'menu_title'    => __( 'Taxonomies', SCM_THEME ),
...
// SCM Filter: Passing empty Array - Receiving Array of Groups
                ...
                $tax_luoghi['fields'] = scm_acf_preset_map_icon( 'luogo-tip-mappa', 1,  100, 100, 0, __( 'Icona Mappa specifica per questa Categoria', SCM_THEME ), $msg );
...
// EDIT SINGLE
                ...
                // + ARTICOLI
                $article = scm_acf_group( __( 'Articolo', SCM_THEME ), 'news-single' );
                ...
                // + SECTION
                $section = scm_acf_group( __( 'Componi Sezione', SCM_THEME ), 'sections-single' );

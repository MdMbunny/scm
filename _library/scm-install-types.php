...
function scm_hook_types_default(){
    ...
    $default_types = array(
        ...
        'articoli'              => array( 'admin' => 0,      'custom' => 1,         'add_cap' => 1,         'active' => 1,      'public' => 1,       'hidden' => 0,      'post' => 1,       'link' => 'popup',      'link-field' => '',                                                                                         'singular' => __('Articolo', SCM_THEME),               'plural' => __('Articoli', SCM_THEME),              'slug' => 'articoli',           'fa-icon' => 'fa-newspaper-o',       'icon' => 'admin-post',        'orderkey' => '',             'orderby' => 'date',        'ordertype' => '',      'menupos' => 0,         'menu' => 'types',                                                                                                           ),
        'slides'                => array( 'admin' => 0,      'custom' => 1,         'add_cap' => 1,         'active' => 1,      'public' => 1,       'hidden' => 0,      'post' => 1,       'link' => '',           'link-field' => '',                                                                                         'singular' => __('Slide', SCM_THEME),                  'plural' => __('Slides', SCM_THEME),                'slug' => 'slides',             'fa-icon' => 'fa-picture-o',         'icon' => 'format-image',      'orderkey' => '',             'orderby' => 'date',        'ordertype' => '',      'menupos' => 0,         'menu' => 'media',                                                                                                           ),

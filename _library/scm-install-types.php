...
function scm_hook_types_default(){
    ...
    $default_types = array(
        ...
        'luoghi'                => array( 'admin' => 0,      'custom' => 1,         'add_cap' => 1,         'active' => 1,      'public' => 1,       'hidden' => 0,      'post' => 0,       'link' => 'link',       'link-field' => 'map',                                                                                      'singular' => __('Luogo', SCM_THEME),                  'plural' => __('Luoghi', SCM_THEME),                'slug' => 'luoghi',             'fa-icon' => 'fa-map-marker',        'icon' => 'location',          'orderkey' => '',             'orderby' => 'title',       'ordertype' => '',      'menupos' => 1,         'menu' => 'contacts',                                                                                                        ),
    );

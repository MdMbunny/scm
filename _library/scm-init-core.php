...
function scm_hook_site_register_styles_inline() {
    ...
    if( $cont_fade )
        $css .= '.content-fade .has-fade{ opacity: 0; transition: opacity .5s; }' . lbreak();
        //$css .= '.content-fade ' . str_replace( ',', ', .content-fade ', str_replace( ' ', '', $cont_fade ) ) . '{ opacity: 0; transition: opacity .5s; }' . lbreak();
